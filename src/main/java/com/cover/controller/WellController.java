...
//	  list.add(ss);	  
	...
	public Well getWellByOrderNO(String wellOrder) {	
		Well well=wellService.selectWellByorderON(wellOrder);//String orderNO=request.getParameter("wellOrder");
